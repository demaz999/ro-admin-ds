...
<template>
  <div data-slot="slideshow" class="flex w-full flex-col gap-2">
    ...
    <!--
      Лента в мастере ровно по ширине главного кадра: 640 при кадре 640 и 288
      при 288. Превью в неё не помещаются — одиннадцать по 104 с зазором 8 дают
      1224, — то есть лента обрезает и прокручивается. Без ограничения ширины
      она вылезала за края картинки.
    -->
    <div class="flex w-full items-end gap-2 overflow-x-auto">
      <button
