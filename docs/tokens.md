...
> Оговорка: часть рамп по значению близка к семантическим токенам (шестая — красная, как
> `service/error`; первая — зелёная, как `service/success`). Если после сверки значений
> совпадение окажется буквальным, цветовые имена дадут два разных токена под один цвет и это
> собьёт сборку. Тогда правильнее номерная схема. Финальный выбор — после сводки значений.
