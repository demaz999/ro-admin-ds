...
<template>
  <main :data-theme="theme" class="mx-auto max-w-5xl space-y-12 bg-background px-6 py-10 font-sans text-foreground">
    ...
    <ShowcaseSection
      title="Палитра"
      note="Цветовые роли в порядке docs/naming.md, раздел 2. Свотч залит через var(), hex читается в выбранной теме; «из rososmotr» — роль, которую тема не переопределяет. Сверка значений с китом 1 — docs/tokens.md, разделы 6 и 7."
    >
