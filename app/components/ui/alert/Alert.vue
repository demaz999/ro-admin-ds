...
<template>
  ...
  >
    ...
    <div class="flex min-w-0 flex-1 flex-col items-start gap-1">
      ...
      <!-- Кегль действия в мастере — 16/20, а у перенесённого `ButtonAction` его
           нет: внутри уведомления инстанцирован ДРУГОЙ мастер (`1028:8221`,
           размер 16/20), а не тот, с которого волна 2 переносила компонент
           (`6626:56755`, размеры 15/20 и 13/16). Два живых мастера под одним
           именем — противоречие, а не дыра: решается человеком, а не здесь.
           Пока стоит перенесённый размер. См. docs/open-questions.md. -->
