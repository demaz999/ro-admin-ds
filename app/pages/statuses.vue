...
const MODELS: { name: string, companies: string[] }[] = [
  ...
  { name: 'Тестовая модель 1', companies: ['Альфа Страхование', 'Сбер', 'Согаз'] },
  { name: 'Тестовая модель 2', companies: ['Т-Страхование'] },
  { name: 'Тестовая модель 3', companies: ['Т-Страхование'] },
