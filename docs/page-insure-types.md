...
|---|---|---|---|
| **колонка действий** | пороги «1–3 инлайном, 4+ кебаб», очередь инлайн-слотов, резерв до трёх иконок (`slots`) | не больше двух слотов 24×24 через 8: левый — одно вторичное иконкой или кебаб, правый — карандаш всегда. Проп `slots` и очередь убраны | решение владельца (A) |
...
| **подпись и тултипы** | подпись у одного действия, тултипы у 2–3 иконок | подпись — только при одном слоте; при двух слотах тултип у обеих иконок | решение владельца (A) |
| **ширина колонки** | резерв компонентом под максимум слотов | резервирует страница: без вторичных — слот и подпись, со вторичными — два слота; демо смешивает виды и держит `w-44` | решение владельца (A) |
